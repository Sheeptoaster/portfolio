            ...
            <div className="container">
                <div className="roww resumo_fn_contact">
                    ...
                    <div className="resumo_fn_main_title">
                        ...
                        <p className="desc">
                            If you have any suggestions, projects to work on, or
                            just want to say hello, please fill out the form
                            below and I will reply to you as soon as possible.
                        </p>
                    </div>
                    {/* /Main Title */}
                    {/* Contact Form */}
                    ...
                    >
                        ...
                        >
                            <span className="contact_success">
                                Your message has been received, I will contact
                    ...
                    <div className="resumo_fn_contact_info">
                        ...
                        <p>
                            <a href="https://github.com/Sheeptoaster" style={{"color": "#DDDDDD"}}>
                                GitHub
                            </a>
                        </p>
                        <p>
                            <a href="https://www.linkedin.com/in/jacob-weber-662a08153/" style={{"color": "#DDDDDD"}}>
                                LinkedIn
                            </a>
                        </p>
                    </div>
